...
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { children: routes.map(({ name, path }) => {
      return /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: path, children: name }) }, path);
    }) }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Routes, { children: routes.map(({ path, component: RouteComp }) => {
      return /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path, element: /* @__PURE__ */ jsxRuntimeExports.jsx(RouteComp, {}) }, path);
    }) })
  ] });
}
client.hydrateRoot(
